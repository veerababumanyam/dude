...
/**
 * Demo user profiles. This app has no auth — the active profile is chosen
 * directly from the switcher (sidebar on desktop, header on mobile) and is
 * purely presentational for now.
 */
export const PROFILES: Profile[] = [
  { id: "arjun", name: "Arjun Mehta", role: "Regional Manager", initials: "AM" },
  { id: "priya", name: "Priya Nair", role: "Sales Executive", initials: "PN" },
  { id: "vikram", name: "Vikram Rao", role: "Operations Head", initials: "VR" },
];
...
export const HANDOVER_INFO = ["Builder", "Association", "Others"];
...
export const STATUS_OPTIONS = [
  ...
  {
    value: "Need to Share Profile",
    color: "#b45309",
    bg: "bg-amber-100 text-amber-800 border-amber-200",
  },
  {
    value: "Need to Send Quotation",
    color: "#b45309",
    bg: "bg-amber-100 text-amber-800 border-amber-200",
  },
  {
    value: "Need to Survey",
    color: "#7e22ce",
    bg: "bg-purple-100 text-purple-800 border-purple-200",
  },
  {
    value: "Survey is Done",
    color: "#15803d",
    bg: "bg-green-100 text-green-800 border-green-200",
  },
];

export const TIMING_OPTIONS = ["Residential", "Commercial", "Hospital (24/7)"];
