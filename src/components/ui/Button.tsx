...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "default", ...props }, ref) => {
    const variants = {
      primary:
        "bg-brand-700 text-white hover:bg-brand-800 shadow-lg shadow-brand-700/20 font-bold",
      secondary: "bg-brand-50 text-brand-800 hover:bg-rose-100 font-bold",
      outline:
        "border border-brand-500/20 bg-white hover:bg-brand-50 text-neutral-900 transition-colors font-bold",
